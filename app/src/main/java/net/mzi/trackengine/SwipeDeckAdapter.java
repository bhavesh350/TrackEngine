...
//                            Log.e( "onClick:reject ",data.get(position).IssueID );
                            ...
                            final ApiResult.IssueDetail issueDetail = apiResult.new IssueDetail(sUserId,
                                    sParentComapnyId, data.get(position).IssueID, sAcceptStatus,
                                    commemt.getText().toString(), currentDateTimeString, sDepartmentId,
                                    "", "", "", sDeviceId, "-1",
                                    "", "", "");
            ...
            public void onClick(View v) {
                ...
                if (cqueryTemp.getCount() > 0) {
                    ...
                    final ApiResult.IssueDetail issueDetail =
                            apiResult.new IssueDetail(sUserId, sParentComapnyId,
                                    data.get(position).IssueID, sAcceptStatus, "Accept by Engineer",
                                    currentDateTimeString, sDepartmentId, "", "", "",
                                    sDeviceId, "true", "", "", "");
                    Call<ApiResult.IssueDetail> call1 = apiInterface.PostTicketStatus(issueDetail);
